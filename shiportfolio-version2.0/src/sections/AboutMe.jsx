      ...
      <div className='flex flex-col lg:flex-row gap-16 items-start justify-between'>
        ...
        >
          ...
          <p className='text-sm text-justify leading-6 whitespace-pre-line mt-4'>
            You can call me <span className='text-green-600'>"Shi"</span> — a coffee lover with a passion for technology and community supporting works.
            I describe myself as someone who is always eager to grow, connect, and explore new opportunities that help me improve.
            As a <span className="text-green-600">web developer</span> and <span className="text-green-600">community enthusiast</span>,
